...
function AddListing() {
  const [formData, setFormData] = useState({
    title: "", description: "", rent: "", bedrooms: 1, bathrooms: 1,
    line: "", area: "", station: "", amenities: []
  });
  ...
  const handleSubmit = async (e) => {
    ...
    for (const key of ["title","description","rent","bedrooms","bathrooms","line","area","station"]) {
    ...
    try {
      ...
      alert("Listing added!"); console.log(res.data);
    } catch (err) {
  ...
  <form onSubmit={handleSubmit} encType="multipart/form-data">
    ...
    {preview && <img src={preview} alt="preview" width="200" style={{ marginTop: "1rem", borderRadius: "8px" }} />}
